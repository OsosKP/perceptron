...
class MultiLayerPerceptron:
    ...
    def forward(self, input):
        ...
        self.activations_lower = np.array(
            list(map(lambda x: self.activation[self.activation_type](x), self.total_net_inputs_lower)))
        # Net_O
        ...
        self.activations_upper = np.array(
            list(map(lambda x: self.activation[self.activation_type](x), self.total_net_inputs_upper)))
